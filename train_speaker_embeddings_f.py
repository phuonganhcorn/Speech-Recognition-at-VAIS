...
class PreTrainer(sb.core.Brain):
    ...
    def load_pretrained_model(self):
        pretrain = Pretrainer(loadables={'model': self.model}, paths={'model': ''})
        pretrain.collect_files()
        pretrain.load_collected(device='cpu')
        
        # Or web
        pretrain = Pretrainer(collect_in='model_web', loadables={'model': self.model}, paths={'model': 'https://www.dropbox.com/s/2mdnl784ram5w8o/embedding_model.ckpt?dl=1'})
        pretrain.collect_files()
        pretrain.load_collected(device='cpu')
...
def dataio_prep(hparams):
    ...
    def audio_pipeline(wav, start, stop, duration):
        ...
        # check num of dimensions of wav       
...
if __name__ == "__main__":
    ...
    model_path = '/home/phuonganh/speechbrain/pretrained_models/spkrec-ecapa-voxceleb/embedding_model.ckpt'
